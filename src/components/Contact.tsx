  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="relative">
        ...
        >
          <div
            className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80f0ff] to-[#89fc9c] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Our dedication lies in delivering superior health products, promoting
          wellness and positive engagement. Reach out to us to learn more about
          our product.
        </p>
      </div>
      <form
      ...
      >
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-gradient-to-br from-green-600 to-green-900 border-green-400 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
          >
            Let&apos;s talk about our product
          </button>
        </div>
      </form>
    </div>
